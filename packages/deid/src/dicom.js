...
exports.scrubDICOM = scrubDICOM;
exports.verifyDICOMDeID = verifyDICOMDeID;
exports.generateDICOMUID = generateDICOMUID;
/**
 ...
 */
function scrubDICOM(buffer, modality, policy) {
 ...
 */
function verifyDICOMDeID(buffer) {
