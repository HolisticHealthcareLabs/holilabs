...
export const getGradient = (direction: 'r' | 'l' | 'br' | 'bl' = 'r') => {
  return `bg-gradient-to-${direction} from-[${theme.colors.gradientFrom}] to-[${theme.colors.gradientTo}]`;
};

// Export individual values for easy import
export const { colors, typography, spacing, shadows, animations } = theme;
