...
exports.IOSInstallPrompt = IOSInstallPrompt;
...
function IOSInstallPrompt() {
    ...
    return (<div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gradient-to-t from-black/90 to-transparent animate-slide-up pb-safe">
      <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6">
        {/* Close button */}
        <button onClick={handleDismiss} className="absolute top-2 right-2 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" aria-label="Cerrar">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                ...
                <outline_1.ArrowUpTrayIcon className="inline w-5 h-5 mx-1 text-blue-600"/>
        ...
        <div className="flex gap-2">
          <button onClick={handleDismiss} className="flex-1 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
            Ahora no
          </button>
          <button onClick={handleDismiss} className="flex-1 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-lg transition-colors">
            Entendido
          </button>
        </div>
      </div>
...
//# sourceMappingURL=IOSInstallPrompt.js.map