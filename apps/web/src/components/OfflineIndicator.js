...
function OfflineIndicator() {
    ...
    const PersistentIndicator = () => (<div className={`fixed bottom-4 left-4 z-50 flex items-center space-x-2 px-3 py-2 rounded-lg shadow-lg transition-all ${isOnline
    ...
    const ToastNotification = () => {
        if (!showNotification)
            return null;
        return (<div className="fixed top-4 right-4 z-50 animate-in slide-in-from-top-5 duration-300">
        <div className={`flex items-center space-x-3 px-6 py-4 rounded-xl shadow-2xl ${isOnline
