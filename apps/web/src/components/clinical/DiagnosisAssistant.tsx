        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {formData.symptoms.map((symptom, index) => (
                  <span
                    key={index}
                    className="px-3 py-1 bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-400 rounded-full text-sm flex items-center gap-2"
                  >
                    {symptom}
                    <button
                      type="button"
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition shadow-lg"
            >
              {loading ? (
                ...
                <div className="space-y-4">
                  {result.differentialDiagnosis.map((diagnosis, index) => (
                    <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                      ...
                      {diagnosis.icd10Code && (
                        <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">ICD-10: {diagnosis.icd10Code}</div>
                      )}
