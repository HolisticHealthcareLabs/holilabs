...
export function PrintableSOAPNote({
  note,
  patient,
  clinicInfo,
}: PrintableSOAPNoteProps) {
  ...
  return (
    <div className="printable-document page-break-avoid">
      {/* Print Header */}
      <div className="print-header">
        {clinicInfo && (
          <div className="mb-4">
            ...
            {clinicInfo.phone && (
              <p className="text-sm text-gray-600">Tel: {clinicInfo.phone}</p>
            )}
          </div>
        )}
            ...
            <div className="mt-3">
              ...
              <div className="code-list">
                {note.diagnoses.map((diagnosis, index) => (
                  <div key={index} className="code-item mb-2">
      ...
      {/* Signature Section */}
      {note.author && (
        <div className="signature-section page-break-avoid">
