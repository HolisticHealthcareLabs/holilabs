...
function getCSP() {
    ...
    const cspDirectives = [
        ...
        `connect-src 'self' ${process.env.NEXT_PUBLIC_SUPABASE_URL || ''} https://*.supabase.co ${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'} wss://localhost:* ws://localhost:*`,
...
function applySecurityHeaders(response) {
    ...
    response.headers.set('Access-Control-Allow-Headers', 'X-Requested-With, Content-Type, Authorization, X-CSRF-Token, X-User-Id, X-Patient-Id');
