...
exports.ClinicalSystemPrompts = void 0;
exports.chat = chat;
exports.buildPatientContext = buildPatientContext;
exports.checkDrugInteractions = checkDrugInteractions;
exports.getDifferentialDiagnosis = getDifferentialDiagnosis;
exports.getTreatmentRecommendations = getTreatmentRecommendations;
// ============================================================================
// CLINICAL SYSTEM PROMPTS
// ============================================================================
exports.ClinicalSystemPrompts = {
...
// ============================================================================
async function chatWithClaude(request) {
    try {
        ...
        const systemPrompt = request.systemPrompt || exports.ClinicalSystemPrompts.general;
...
async function chatWithOpenAI(request) {
    try {
        ...
        const messages = [
            {
                role: 'system',
                content: request.systemPrompt || exports.ClinicalSystemPrompts.general,
            },
            ...request.messages,
        ];
...
function buildPatientContext(patient) {
    ...
    if (patient.ageBand)
        context += `- Edad: ${patient.ageBand}\n`;
    if (patient.gender)
        context += `- Sexo: ${patient.gender}\n`;
...
async function checkDrugInteractions(medications) {
    ...
    return chat({
        ...
        systemPrompt: exports.ClinicalSystemPrompts.drugInteractions,
        provider: 'claude',
    });
}
/**
 ...
 */
async function getDifferentialDiagnosis(symptoms, patientContext) {
    ...
    return chat({
        ...
        systemPrompt: exports.ClinicalSystemPrompts.differential,
        provider: 'claude',
    });
}
/**
 ...
 */
async function getTreatmentRecommendations(diagnosis, patientContext) {
    ...
    return chat({
        ...
        systemPrompt: exports.ClinicalSystemPrompts.treatment,
        provider: 'claude',
    });
}
