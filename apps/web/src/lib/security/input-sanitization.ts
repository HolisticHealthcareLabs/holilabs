 ...
 */
export function validateDose(dose: string): boolean {
  if (!dose || typeof dose !== 'string') return false;
 ...
 */
export function isSafeString(input: string, allowSpaces: boolean = true): boolean {
