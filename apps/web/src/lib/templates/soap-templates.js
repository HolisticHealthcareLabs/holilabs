...
exports.portugueseTemplates = exports.spanishTemplates = void 0;
exports.getTemplatesByLanguage = getTemplatesByLanguage;
exports.getTemplateById = getTemplateById;
exports.getTemplatesBySpecialty = getTemplatesBySpecialty;
/**
 * Spanish Templates (Mexico, Colombia, Argentina)
 */
exports.spanishTemplates = [
    {
        id: 'es-follow-up',
        name: 'Consulta de Seguimiento General',
        language: 'es',
        chiefComplaint: 'Control médico de rutina',
        subjective: 'Paciente refiere evolución favorable desde última consulta. Niega nuevos síntomas. Cumplimiento adecuado del tratamiento indicado. Sin eventos adversos reportados.',
        objective: 'Paciente en buen estado general, consciente, orientado, colaborador. Signos vitales estables. Examen físico sin hallazgos patológicos agudos.',
    ...
    },
    {
        ...
        subjective: 'Paciente con diabetes mellitus tipo 2 diagnosticada hace X años. Refiere adherencia variable a tratamiento. Glucemias en ayuno entre X-X mg/dL. Niega hipoglucemias. Polidipsia y poliuria ocasionales.',
        objective: 'Examen físico: Peso X kg, IMC X. Pulsos pedios presentes bilateralmente. Sensibilidad conservada en ambos pies. Sin lesiones dérmicas activas.',
        assessment: 'Diabetes mellitus tipo 2 con control glucémico subóptimo (HbA1c pendiente). Sin complicaciones micro/macrovasculares evidentes.',
    ...
    },
    {
        ...
        subjective: 'Paciente hipertenso conocido en tratamiento. Refiere tomas de presión domiciliarias entre X/X - X/X mmHg. Buena adherencia a medicación. Niega cefalea, visión borrosa o disnea.',
        objective: 'TA: X/X mmHg (brazo derecho, sentado). FC: X lpm regular. Auscultación cardiopulmonar sin alteraciones. Edemas de miembros inferiores ausentes.',
    ...
    },
    {
        ...
        subjective: 'Paciente refiere inicio agudo hace 3 días con fiebre cuantificada hasta 38.5°C, tos productiva con expectoración amarillenta, odinofagia moderada. Niega disnea, dolor torácico o hemoptisis.',
        objective: 'T: 37.8°C. FR: 18 rpm. SatO2: 96% aire ambiente. Orofaringe hiperémica. Auscultación pulmonar con estertores crepitantes en base derecha.',
        assessment: 'Infección aguda de vías respiratorias superiores, probable etiología viral. Sospecha de bronquitis aguda.',
    ...
    },
    {
        ...
        subjective: 'Padres refieren niño activo, jugando normalmente. Alimentación adecuada. Desarrollo psicomotor acorde a edad. Esquema de vacunación completo.',
        objective: 'Peso: X kg (percentil X). Talla: X cm (percentil X). Perímetro cefálico: X cm. Examen físico sin alteraciones. Desarrollo neurológico normal.',
    ...
    },
    {
        ...
        subjective: 'Paciente acude para control ginecológico anual. Ciclos menstruales regulares cada 28-30 días. Niega sangrado intermenstrual, dismenorrea severa o dispareunia. Última citología hace 1 año sin alteraciones.',
        objective: 'Examen físico: Mamas simétricas, sin masas palpables. Abdomen blando, no doloroso. Especuloscopia: cérvix rosado, sin lesiones. Tacto vaginal bimanual: útero en anteroversión, móvil, no doloroso. Anexos no palpables.',
    ...
    },
    {
        ...
        subjective: 'Paciente refiere aparición de lesiones acneicas en rostro desde hace 6 meses. Empeoran con estrés y periodo menstrual. Ha usado limpiadores faciales de venta libre sin mejoría significativa.',
        objective: 'Examen dermatológico: Rostro con comedones abiertos y cerrados en zona T. Pápulas y pústulas eritematosas en mejillas y frente. Algunas lesiones inflamatorias. Sin nódulos ni quistes. Piel de tipo graso.',
    ...
    },
    {
        ...
        subjective: 'Paciente refiere ansiedad persistente durante los últimos 6 meses. Preocupación excesiva por múltiples aspectos de su vida cotidiana. Dificultad para controlar la preocupación. Asocia tensión muscular, fatiga, dificultad para concentrarse e insomnio de conciliación.',
        objective: 'Paciente alerta, orientado en persona, tiempo y espacio. Ansioso durante la entrevista. Discurso coherente y organizado. Afecto concordante con estado de ánimo ansioso. Sin ideas suicidas, homicidas ni síntomas psicóticos. Insight y juicio preservados.',
        assessment: 'Trastorno de ansiedad generalizada (F41.1). Impacto moderado en funcionamiento social y laboral.',
    ...
    },
    {
        ...
        subjective: 'Paciente refiere dolor torácico intermitente desde hace 1 semana. Dolor punzante en hemitórax izquierdo, no irradiado, que dura segundos. No relacionado con esfuerzo físico. Niega disnea, palpitaciones, síncope o diaforesis.',
        objective: 'PA: 130/80 mmHg, FC: 76 lpm regular. Auscultación cardíaca: ruidos rítmicos, sin soplos. Auscultación pulmonar sin alteraciones. Pulsos periféricos palpables y simétricos. Sin edemas.',
        assessment: 'Dolor torácico atípico. Bajo riesgo cardiovascular. Probable origen musculoesquelético.',
    ...
    },
    {
        ...
        subjective: 'Paciente refiere torcedura de tobillo derecho hace 2 días tras caída. Escuchó "chasquido". Dolor intenso inicial, ahora moderado. Inflamación y dificultad para caminar. Ha aplicado hielo intermitentemente.',
        objective: 'Tobillo derecho: edema moderado en región maleolar lateral. Equimosis leve. Dolor a la palpación del ligamento peroneoastragalino anterior. Prueba de cajón anterior positiva. Sin deformidad ósea evidente. Movilidad activa limitada por dolor.',
        assessment: 'Esguince de tobillo derecho grado II (ruptura parcial del ligamento lateral externo).',
 ...
 */
exports.portugueseTemplates = [
    {
        id: 'pt-follow-up',
        name: 'Consulta de Acompanhamento Geral',
        language: 'pt',
        chiefComplaint: 'Controle médico de rotina',
        subjective: 'Paciente refere evolução favorável desde última consulta. Nega novos sintomas. Aderência adequada ao tratamento indicado. Sem eventos adversos reportados.',
        objective: 'Paciente em bom estado geral, consciente, orientado, colaborativo. Sinais vitais estáveis. Exame físico sem achados patológicos agudos.',
    ...
    },
    {
        ...
        subjective: 'Paciente com diabetes mellitus tipo 2 diagnosticada há X anos. Refere aderência variável ao tratamento. Glicemias em jejum entre X-X mg/dL. Nega hipoglicemias. Polidipsia e poliúria ocasionais.',
        objective: 'Exame físico: Peso X kg, IMC X. Pulsos pediosos presentes bilateralmente. Sensibilidade preservada em ambos os pés. Sem lesões dérmicas ativas.',
        assessment: 'Diabetes mellitus tipo 2 com controle glicêmico subótimo (HbA1c pendente). Sem complicações micro/macrovasculares evidentes.',
    ...
    },
    {
        ...
        subjective: 'Paciente hipertenso conhecido em tratamento. Refere medidas de pressão domiciliares entre X/X - X/X mmHg. Boa aderência à medicação. Nega cefaleia, visão turva ou dispneia.',
        objective: 'PA: X/X mmHg (braço direito, sentado). FC: X bpm regular. Ausculta cardiopulmonar sem alterações. Edema de membros inferiores ausente.',
        assessment: 'Hipertensão arterial essencial em tratamento. Controle pressórico adequado.',
    ...
    },
    {
        ...
        subjective: 'Paciente refere início agudo há 3 dias com febre quantificada até 38.5°C, tosse produtiva com expectoração amarelada, odinofagia moderada. Nega dispneia, dor torácica ou hemoptise.',
        objective: 'T: 37.8°C. FR: 18 irpm. SatO2: 96% ar ambiente. Orofaringe hiperêmica. Ausculta pulmonar com estertores crepitantes em base direita.',
        assessment: 'Infecção aguda das vias aéreas superiores, provável etiologia viral. Suspeita de bronquite aguda.',
    ...
    // ========================================
    {
        ...
        subjective: 'Paciente refere dor com intensidade [X]/10 na escala numérica. Localização: [região]. Qualidade: [latejante/queimação/aperto/penetrante]. Início: [agudo/gradual]. Padrão temporal: [constante/intermitente]. Fatores agravantes: [movimento/toque/posição]. Fatores atenuantes: [repouso/medicação/posicionamento]. Impacto: [mobilidade/sono/humor/apetite]. Última dose de analgésico: [horário e medicação].',
        objective: 'Paciente apresenta sinais de desconforto: [expressão facial/gemidos/proteção da área/limitação de movimento]. Escala de dor: [X]/10. Sinais vitais: PA X/X mmHg, FC X bpm, FR X irpm. Área dolorosa: [inspeção, palpação, edema, calor]. Funcionalidade: [capacidade de mobilização]. Estado cognitivo: [lúcido/confuso/sedado].',
        assessment: 'Dor [tipo: oncológica/neuropática/visceral/somática] com intensidade [leve/moderada/intensa/intolerável]. Controle analgésico [adequado/inadequado/subótimo]. Qualidade de vida impactada pela dor. Sem sinais de emergência álgica.',
    ...
    },
    {
        ...
        objective: 'Familiares presentes: [número] pessoas. Estado emocional: [calmos/ansiosos/chorosos/revoltados]. Comunicação: [clara/dificultada]. Compreensão das informações: [boa/necessita repetição]. Presença de cuidador principal: [sim/não], [nome]. Suporte social: [adequado/limitado/ausente]. Documentação: [diretivas antecipadas assinadas/pendentes].',
        assessment: 'Família [bem informada/necessita esclarecimentos] sobre quadro clínico e prognóstico. Objetivos de cuidado: [alinhados/em discussão]. Família demonstra [capacidade/dificuldade] para participar dos cuidados. Apoio psicossocial: [necessário/em andamento]. Planejamento de cuidados: [claro/necessita revisão].',
 ...
 */
function getTemplatesByLanguage(language) {
    return language === 'es' ? exports.spanishTemplates : exports.portugueseTemplates;
}
/**
 * Get template by ID
 */
function getTemplateById(id, language) {
 ...
 */
function getTemplatesBySpecialty(specialty, language) {
    const templates = getTemplatesByLanguage(language);
    return templates.filter((t) => t.specialty === specialty);
}
//# sourceMappingURL=soap-templates.js.map