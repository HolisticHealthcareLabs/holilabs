...
export interface MCPTool {
    ...
    category: 'patient' | 'clinical-note' | 'governance' | 'medication' | 'diagnosis' | 'clinical-decision' | 'appointment' | 'scheduling' | 'admin' | 'messaging' | 'document' | 'form' | 'portal' | 'notification' | 'lab' | 'billing' | 'referral' | 'settings' | 'ai' | 'consent' | 'scribe' | 'prevention' | 'search' | 'analytics' | 'role-admin' | 'task' | 'escalation' | 'workspace' | 'compliance' | 'safety' | 'care-coordination' | 'vbc';
