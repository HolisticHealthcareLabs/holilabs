...
logger_1.logger.trace('This is a trace message (very detailed)');
logger_1.logger.debug('This is a debug message');
logger_1.logger.info('This is an info message');
logger_1.logger.warn('This is a warning message');
logger_1.logger.error('This is an error message');
logger_1.logger.fatal('This is a fatal message');
...
try {
    ...
    logger_1.logger.error((0, logger_1.logError)(error), 'Failed to process request');
}
...
// Simulate work
setTimeout(() => {
    logger_1.logger.info((0, logger_1.logPerformance)('database-query', start), 'Query completed');
