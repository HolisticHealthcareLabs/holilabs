...
exports.notifyPatientSOAPReady = notifyPatientSOAPReady;
exports.notifyPatientPrescription = notifyPatientPrescription;
exports.notifyDoctorSignatureRequest = notifyDoctorSignatureRequest;
 ...
 */
async function notifyPatientSOAPReady({ patientPhone, patientName, doctorName, noteUrl, language = 'pt', }) {
    try {
 ...
 */
async function notifyPatientPrescription({ patientPhone, patientName, doctorName, prescriptionUrl, medications, language = 'pt', }) {
    try {
        const client = getTwilioClient();
        const fromNumber = getTwilioWhatsAppNumber();
        const toNumber = formatWhatsAppNumber(patientPhone);
 ...
 */
async function notifyDoctorSignatureRequest({ doctorPhone, doctorName, patientName, signatureUrl, language = 'pt', }) {
    try {
        const client = getTwilioClient();
        const fromNumber = getTwilioWhatsAppNumber();
 ...
 */
async function notifyAppointmentReminder({ patientPhone, patientName, doctorName, appointmentDate, appointmentTime, clinicAddress, language = 'pt', }) {
    try {
        const client = getTwilioClient();
        const fromNumber = getTwilioWhatsAppNumber();
        const toNumber = formatWhatsAppNumber(patientPhone);
 ...
 */
async function sendAppointmentConfirmationWhatsApp(patientPhone, patientName, dateTime, clinicianName, confirmationUrl, language = 'es') {
    try {
        const client = getTwilioClient();
        const fromNumber = getTwilioWhatsAppNumber();
        const toNumber = formatWhatsAppNumber(patientPhone);
 ...
 */
async function notifyTestResults({ patientPhone, patientName, doctorName, testName, resultsUrl, language = 'pt', }) {
    try {
        const client = getTwilioClient();
        const fromNumber = getTwilioWhatsAppNumber();
        const toNumber = formatWhatsAppNumber(patientPhone);
