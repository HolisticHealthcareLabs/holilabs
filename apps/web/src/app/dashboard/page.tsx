          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Link
                  href="/dashboard/patients"
                  className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/30 hover:from-blue-100 hover:to-blue-200 dark:hover:from-blue-900/30 dark:hover:to-blue-900/40 rounded-xl transition group shadow-sm hover:shadow-md"
                >
                  <div className="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition mb-3 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                  </div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-center mb-1">Patients</h4>
                  <p className="text-xs text-gray-600 dark:text-gray-400 text-center">Manage all patients</p>
                </Link>

                {/* New Registration */}
                <Link
                  href="/dashboard/patients/new"
                  className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/30 hover:from-green-100 hover:to-green-200 dark:hover:from-green-900/30 dark:hover:to-green-900/40 rounded-xl transition group shadow-sm hover:shadow-md"
                >
                  <div className="w-16 h-16 bg-green-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition mb-3 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                    </svg>
                  </div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-center mb-1">New Patient</h4>
                  <p className="text-xs text-gray-600 dark:text-gray-400 text-center">Quick registration</p>
                </Link>

                {/* AI Clinical Tools */}
                <Link
                  href="/dashboard/diagnosis"
                  className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/30 hover:from-purple-100 hover:to-purple-200 dark:hover:from-purple-900/30 dark:hover:to-purple-900/40 rounded-xl transition group shadow-sm hover:shadow-md"
                >
                  <div className="w-16 h-16 bg-purple-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition mb-3 shadow-lg">
                    <span className="text-3xl">🏥</span>
                  </div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-center mb-1">Clinical Tools</h4>
                  <p className="text-xs text-gray-600 dark:text-gray-400 text-center">AI diagnosis & insights</p>
                </Link>

                {/* AI Scribe */}
                <Link
                  href="/dashboard/scribe"
                  className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-900/20 dark:to-teal-900/30 hover:from-teal-100 hover:to-teal-200 dark:hover:from-teal-900/30 dark:hover:to-teal-900/40 rounded-xl transition group shadow-sm hover:shadow-md"
                >
                  <div className="w-16 h-16 bg-teal-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition mb-3 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                    </svg>
                  </div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-center mb-1">AI Scribe</h4>
                  <p className="text-xs text-gray-600 dark:text-gray-400 text-center">Voice documentation</p>
                </Link>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <details className="group">
                  <summary className="flex items-center justify-between cursor-pointer text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition">
                  ...
                  <div className="mt-3 space-y-2">
                    <Link href="/dashboard/ai" className="flex items-center gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition text-sm">
                    ...
                    <button onClick={() => setShowExportModal(true)} className="w-full flex items-center gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition text-sm">
                      <div className="w-8 h-8 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center">
                        <svg className="w-4 h-4 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                      </div>
                      <span className="font-medium text-gray-900 dark:text-white">Export Billing</span>
                    </button>
                  </div>
                </details>
              </div>
