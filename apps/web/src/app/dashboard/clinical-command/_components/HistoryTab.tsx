...
import {
  Heart, Pill, AlertTriangle, Activity, FileText,
  Users, Syringe, FlaskConical, ChevronDown, ChevronRight,
  ...
  return (
    <div className="h-full overflow-y-auto text-[12px] leading-relaxed">
      ...
      {labResults && labResults.length > 0 && (
        <Section title="Lab Results" icon={FlaskConical} count={labResults.length} accent="text-blue-400" defaultOpen={false}>
          <ul className="space-y-1.5">
            {labResults.map((lr, i) => (
