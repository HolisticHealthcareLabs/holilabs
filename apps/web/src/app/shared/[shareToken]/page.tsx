...
export default function SharedRecordPage({ params }: { params: { shareToken: string } }) {
  ...
  const fetchSharedRecord = async (pwd?: string) => {
    setIsVerifying(true);
    try {
  ...
  const handleDownloadPDF = async () => {
    if (!shareInfo?.allowDownload) return;
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isVerifying ? (
                <>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center">
        <div className="text-center">
          <svg
            className="w-12 h-12 text-green-600 animate-spin mx-auto mb-4"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
        ...
        <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-xl shadow-lg p-6 mb-6 text-white">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <svg
                className="w-12 h-12 opacity-50 mb-2 ml-auto"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
