...
exports.default = ConsultationDetailPage;
...
function ConsultationDetailPage() {
    ...
    if (error || !recording) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
          ...
          <link_1.default href="/portal/consultations" className="block w-full px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg font-semibold text-center shadow-lg hover:shadow-xl transition-all">
            Volver a Consultas
          </link_1.default>
        </div>
      </div>);
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <link_1.default href="/portal/consultations" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-4 transition-colors">
        ...
        {(soapNotes || recording.transcript) && (<framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
            ...
            <div className="p-6">
              {activeTab === 'soap' && soapNotes ? (<div className="space-y-6">
                ...
                </div>) : activeTab === 'transcript' && recording.transcript ? (<div>
