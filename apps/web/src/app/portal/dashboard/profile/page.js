    ...
    if (error || !profile) {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <button onClick={fetchProfile} className="px-4 py-2 bg-red-100 text-red-800 rounded-lg hover:bg-red-200 transition-colors">
              Reintentar
            </button>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
            <div className="flex items-center gap-6">
              <div className="w-24 h-24 bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                <outline_1.UserIcon className="h-12 w-12 text-white"/>
              </div>
              <div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => alert('Funci�n de edici�n pr�ximamente')} className="flex items-center gap-2 px-4 py-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                <outline_1.PencilIcon className="h-4 w-4"/>
                Editar
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <outline_1.IdentificationIcon className="h-5 w-5 text-blue-600"/>
                </div>
                <div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <outline_1.EnvelopeIcon className="h-5 w-5 text-green-600"/>
                </div>
                <div>
                  ...
                  {profile.user.emailVerifiedAt && (<p className="text-xs text-green-600 flex items-center gap-1 mt-1">
                      <outline_1.ShieldCheckIcon className="h-3 w-3"/>
                      Verificado
                    </p>)}
                </div>
              </div>
              ...
              {/* Phone */}
              {profile.patient.phone && (<div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <outline_1.PhoneIcon className="h-5 w-5 text-purple-600"/>
                  </div>
                  <div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <outline_1.CalendarIcon className="h-5 w-5 text-orange-600"/>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">Fecha de Nacimiento</p>
                  <p className="font-semibold text-gray-900">
                    {(0, date_fns_1.format)(new Date(profile.patient.dateOfBirth), "d 'de' MMMM, yyyy", {
            locale: locale_1.es,
        })}
                  </p>
                </div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <outline_1.UserIcon className="h-5 w-5 text-pink-600"/>
                </div>
                <div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 p-6">
          ...
          <div className="space-y-4">
            {/* Session Activity */}
            <button onClick={() => router.push('/portal/dashboard/security')} className="w-full flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all">
              <div className="flex items-center gap-3">
                <outline_1.ShieldCheckIcon className="h-6 w-6 text-purple-600"/>
              ...
              <outline_1.PencilIcon className="h-5 w-5 text-gray-400"/>
            </button>

            {/* Change Password */}
            <button onClick={() => alert('Función de cambio de contraseña próximamente')} className="w-full flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all">
              <div className="flex items-center gap-3">
                <outline_1.ShieldCheckIcon className="h-6 w-6 text-blue-600"/>
                <div className="text-left">
            ...
            {/* Two-Factor Auth */}
            <button onClick={() => alert('Función de 2FA próximamente')} className="w-full flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all">
              <div className="flex items-center gap-3">
        ...
        <div className="bg-red-50 rounded-xl border-2 border-red-200 p-6 mb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button onClick={handleLogout} disabled={loggingOut} className="flex items-center gap-2 px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 transition-colors">
