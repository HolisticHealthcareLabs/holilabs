...
export default function MetricsPage() {
  ...
  const getTrendColor = (trend: TrendDirection, metric: string): string => {
  ...
  const getStatusColor = (metric: string, value: number | null): string => {
    ...
    switch (metric) {
      ...
      case 'heartRate':
        ...
        if (value >= 50 && value <= 110) return 'yellow';
        return 'red';
      case 'temperature':
        if (value >= 36.1 && value <= 37.2) return 'green';
        if (value >= 35.5 && value <= 37.5) return 'yellow';
        return 'red';
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br ${
                        getStatusColor('bloodPressure', data?.summary.bloodPressure.systolic || null) === 'green'
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br ${
                        getStatusColor('heartRate', data?.summary.heartRate.value || null) === 'green'
                          ? 'from-red-400 to-red-600'
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br ${
                        getStatusColor('temperature', data?.summary.temperature.value || null) === 'green'
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center bg-gradient-to-br ${
                        getStatusColor('oxygenSaturation', data?.summary.oxygenSaturation.value || null) === 'green'
