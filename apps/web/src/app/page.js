...
function Tooltip({ children, text }) {
    ...
    return (<span className="relative inline-block" onMouseEnter={() => setIsVisible(true)} onMouseLeave={() => setIsVisible(false)}>
      <span className="border-b-2 border-dotted border-blue-400 cursor-help">
        {children}
      </span>
      {isVisible && (<span className="absolute z-50 w-64 px-4 py-3 text-sm text-white bg-gray-900 rounded-lg shadow-xl -top-2 left-1/2 transform -translate-x-1/2 -translate-y-full" role="tooltip" aria-label={text}>
          {text}
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            {/* Main Headline */}
            <h1 className="text-7xl md:text-8xl lg:text-9xl font-bold mb-8 leading-[0.95]" style={{ transform: `translateY(${scrollY * -0.05}px)` }}>
            ...
            {/* Subheadline */}
            <p className="text-2xl md:text-3xl text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto" style={{ transform: `translateY(${scrollY * -0.08}px)` }}>
            ...
            {/* CTA Button */}
            <div className="flex flex-col sm:flex-row items-center justify-center mb-20" style={{ transform: `translateY(${scrollY * -0.1}px)` }}>
              <link_1.default href="#waitlist" className="bg-gradient-to-r from-red-500 to-orange-600 text-white px-12 py-5 rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-2xl shadow-red-500/30">
                Reducir el riesgo.
              </link_1.default>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-16 text-center">
              ...
              <link_1.default href="#waitlist" className="inline-block bg-gradient-to-r from-green-500 to-blue-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-2xl shadow-green-500/30">
