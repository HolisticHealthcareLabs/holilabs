...
const SOAPNotePDF_1 = require("@/components/pdf/SOAPNotePDF");
...
async function GET(request, { params }) {
    try {
        ...
        const pdfStream = await (0, renderer_1.renderToStream)(react_1.default.createElement(SOAPNotePDF_1.SOAPNotePDF, { record: record }));
        ...
        return new server_1.NextResponse(pdfBuffer, {
            status: 200,
            headers: {
