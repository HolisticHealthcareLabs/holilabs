...
describe('POST /api/prevention/templates/bulk/deactivate', () => {
  beforeEach(() => jest.clearAllMocks());

  it('deactivates multiple templates successfully', async () => {
    ...
    const req = new NextRequest('http://localhost:3000/api/prevention/templates/bulk/deactivate', {
      method: 'POST',
