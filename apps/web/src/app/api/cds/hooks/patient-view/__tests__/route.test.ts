/**
 * Tests for POST /api/cds/hooks/patient-view
 */
...
describe('POST /api/cds/hooks/patient-view', () => {
  ...
  it('returns CDS cards for patient view (200)', async () => {
    const mockResult = { alerts: [{ severity: 'info', category: 'screening-reminder' }] };
    const mockResponse = { cards: [{ summary: 'Screening overdue' }] };
