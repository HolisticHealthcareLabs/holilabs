...
exports.clinicalTemplates = void 0;
exports.seedClinicalTemplates = seedClinicalTemplates;
...
async function seedClinicalTemplates(userId) {
    console.log('Seeding clinical templates...');
    for (const template of exports.clinicalTemplates) {
    ...
    console.log(` Seeded ${exports.clinicalTemplates.length} clinical templates`);
}
